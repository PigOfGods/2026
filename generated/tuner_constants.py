...
This file is designed to be regenerated by Phoenix Tuner X's Swerve Project Generator.
You can regenerate it by clicking "Generate only TunerConstants" in Tuner X.
Only modify this file if you know what you're doing!

TODO: Use Phoenix Tuner X to configure your swerve drivetrain and regenerate this file.
"""
...
class TunerConstants:
    ...
    # TODO: Tune steer PID gains (kP, kI, kD) and feedforward (kS, kV, kA) for optimal steering response
    _steer_gains = (
    ...
    # TODO: Tune drive PID gains (kP, kI, kD) and feedforward (kS, kV) for optimal drive response
    ...
    # TODO: Tune slip current threshold based on wheel traction testing
    _slip_current: units.ampere = 60.0

    # Initial configs for the drive and steer motors and the azimuth encoder; these cannot be null.
    # Some configs will be overwritten; check the `with_*_initial_configs()` API documentation.
    _drive_initial_configs = configs.TalonFXConfiguration()
    # TODO: Tune steer motor current limits to prevent brownouts while maintaining performance
    ...
    # This needs to be tuned to your individual robot
    # TODO: Measure actual robot max speed and update this value
    ...
    _drive_gear_ratio = 6.75  # SDS MK4i L2
    _steer_gear_ratio = 150.0 / 7.0  # SDS MK4i
    # TODO: Measure actual wheel radius after wear and update for accurate odometry
    ...
    _front_left_encoder_offset: units.rotation = 0.0  # TODO: Calibrate with Phoenix Tuner X
    _front_left_steer_motor_inverted = True
    _front_left_encoder_inverted = False

    _front_left_x_pos: units.meter = 0.342
    _front_left_y_pos: units.meter = 0.381

    # Front Right
    _front_right_drive_motor_id = 3
    _front_right_steer_motor_id = 4
    _front_right_encoder_id = 10
    _front_right_encoder_offset: units.rotation = 0.0  # TODO: Calibrate with Phoenix Tuner X
    _front_right_steer_motor_inverted = True
    _front_right_encoder_inverted = False

    _front_right_x_pos: units.meter = 0.342
    _front_right_y_pos: units.meter = -0.381

    # Back Left
    _back_left_drive_motor_id = 5
    _back_left_steer_motor_id = 6
    _back_left_encoder_id = 11
    _back_left_encoder_offset: units.rotation = 0.0  # TODO: Calibrate with Phoenix Tuner X
    _back_left_steer_motor_inverted = True
    _back_left_encoder_inverted = False

    _back_left_x_pos: units.meter = -0.273
    _back_left_y_pos: units.meter = 0.381

    # Back Right
    _back_right_drive_motor_id = 7
    _back_right_steer_motor_id = 8
    _back_right_encoder_id = 12
    _back_right_encoder_offset: units.rotation = 0.0  # TODO: Calibrate with Phoenix Tuner X
    _back_right_steer_motor_inverted = True
    _back_right_encoder_inverted = False

    _back_right_x_pos: units.meter = -0.273
    _back_right_y_pos: units.meter = -0.381
